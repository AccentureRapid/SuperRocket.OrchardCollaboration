...
namespace Orchard.CRM.Dashboard
{
    public static class Consts
    {
        ...
        public const string BasicDataPortletContentType = "BasicDataPortlet";
        public const string WorkflowPortletContentType = "WorkflowPortlet";
        public const string NavigationPortletContentType = "NavigationPortlet";
        public const string QueriesPortletContentType = "QueriesPortlet";
        public const string ContentManagementPortletContentType = "ContentManagementPortlet";
        public const string IMAPTPortletContentType = "IMAPPortletContent";
        public const string SidebarProjectionPortletType = "SidebarProjectionPortlet";
