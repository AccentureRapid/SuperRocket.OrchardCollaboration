...
{
    public class ProjectDetailPermissionProvider : IMasterDetailPermissionProvider
    {
        ...
        {
            return content.ContentItem.ContentType == ContentTypes.ProjectContentType && content.As<ContentItemPermissionPart>() != null;
        }
